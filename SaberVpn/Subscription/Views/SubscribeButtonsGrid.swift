...
struct SubscribeButtonsGrid: View {
...
struct SubscribeButtonsGrid_Previews: PreviewProvider {
    static var previews: some View {
        SubscribeButtonsGrid(viewModel: SubscriptionViewModel())
    }
}
